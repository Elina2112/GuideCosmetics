    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (id==R.id.home){
                    startActivity(new Intent(Like.this,Guide.class));
                    finish();
                }
                if (id==R.id.like){
                   // startActivity(new Intent(Like.this,Like.class));  finish();
                }
                if (id==R.id.search_item){
                    startActivity(new Intent(Like.this,Search.class));  finish();
                }
                return false;
            }
        });
        ...
        itemList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(Like.this, InfoActivity.class);
    ...
    public void getData(){
        ...
        if (cursor.getCount() <= 0) {
            ...
            do {
                ...
                // if (cursor.getInt(cursor.getColumnIndex("like"))==1)
                //{R.id.likeView=}
